...
function EmployerForm() {
  ...
  const getJobInformation = async () => {
    // setFormloading(true);
    try {
      const response = await employerapi.getOneJob(jobtitle);
      if (response) {
        setallselected({
          ...
          expereince: response?.experience, //select
          currencyselection: response?.salary_currency, //select
        });
  ...
  //TODO:Get the User Conformation For the Funcation
  ...
  // const handleCancel = () => {
  //   setShowDialog(false);
  //   // Add your logic to execute when user cancels here..
  //   return;
  // };
  ...
  const Submit = async () => {
    ...
    const newdata = {
      ...
      hiring_city: allselected.city,
      experience: allselected.expereince,
      salary_currency: allselected.currencyselection,
      category: allselected.category,
      description: jobDetails.description,
      type: allselected.jobtype,
      hide_company: hide_company,
    ...
    // const confirmed = window.confirm("Are you sure you want to create the job?");
    // if (!confirmed) {
      ...
      {formloading ? (
        ...
        <>
          ...
          >
            ...
            >
              ...
              <h2
                ...
                className="fw-bold"
              >
                {EditData ? 'Update Job' : 'Post A New Job'}
              </h2>
            </div>
            <div>
              <FormControlLabel
          ...
          <div className="mr-md-4 flex items-left flex-col ">
            <div>
              ...
              <div style={{ marginTop: '4rem' }}>
                ...
                <div className="row">
                  ...
                  <div className="col-md-6 mb-2">
                    <label className={styles.inputLabels}>Choose a State</label>
                    <AutoCompleteInput
                  ...
                  <div className="col-md-6 mb-2">
                    <label className={styles.inputLabels}>Choose a City</label>
                    <AutoCompleteInput
                ...
                <div className="row">
                  <div className="col-md-6 mb-2">
                    ...
                    <ResumeSelect
                      ...
                      value={allselected.currencyselection}
                      onChange={handleSelectChange}
                      required
                    />
                  </div>
            ...
            >
              <p>{`${!isaddQuestion ? 'Add Question' : 'Close Question Tab'
                }`}</p>
